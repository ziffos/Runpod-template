...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        gemma_repo=os.environ.get("LTX_GEMMA_REPO", "google/gemma-3-12b-it-qat-q4_0-unquantized"),
        gemma_root=Path(os.environ.get("LTX_GEMMA_ROOT", str(model_root / "gemma-3-12b-it-qat-q4_0-unquantized"))),
