...
def healthcheck() -> dict[str, Any]:
    ...
    return {
        ...
        "vast_workspace_exists": Path("/workspace").exists(),
    }


def normalize_job_input(raw_input: dict[str, Any]) -> dict[str, Any]:
    if raw_input.get("healthcheck"):
        return raw_input
...
def process_job_input(raw_input: dict[str, Any]) -> dict[str, Any]:
